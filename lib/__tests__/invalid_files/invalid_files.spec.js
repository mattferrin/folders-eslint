...
describe("invalid files", () => {
  ...
  it("violate asterisk a", () => {
    expect(function () {
      addon.enforceConfig(
        "lib/__tests__/invalid_files/violate_asterisk_a/.folderslintrc.json"
      );
    }).toThrowError(
      /The following file path does not satisfy any rules `lib\/__tests__\/invalid_files\/violate_asterisk_a\/root\/nested\/nested\/c\.rs`/
    );
  });
});
